...
<div class="margin_left_right">
    <table id="example" class="table table-hover" style="width:100%">
        ...
        <tbody>
            <tr>
                <td><img src="../../resources/asset/images/Anonymous_Mask.png" class="navbar_profile_icon_name"> Tiger
                    Nixon
                </td>
                ...
                <td class="grey_font"><a href=""><img
                            src="../../resources/asset/css/zondicons/zondicons/edit-pencil.svg"
                            style="width: 15px;margin-right: 20px;    filter: invert(0.5);" alt=""></a><a href=""><img
                            src="../../resources/asset/css/zondicons/zondicons/close.svg"
                            style="width: 15px;    filter: invert(0.5);" alt=""></a>
                </td>
            </tr>
            <tr>
                <td><img src="../../resources/asset/images/Anonymous_Mask.png" class="navbar_profile_icon_name"> Airi
                    Satou
                </td>
                <td>Accountant</td>
                <td>Tokyo</td>
...
<script src="../../resources/asset/js/jquery.js"></script>
<script src="../../resources/asset/js/datatables.min.js"></script>
